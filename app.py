...
def login():
    if request.method == 'POST':
        ...
        role = dict(title="Должность", content="Начальник отдела по управлению персоналом.")
        category = dict(title="Класс", content="Руководитель.")
        ...
        data = [role, category, goals, tasks, edu_req, skills, mustknow, personal_quals]
